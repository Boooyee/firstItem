...
angular.module("admin")
    .directive('citySelect', function (areaData,$timeout) {
        return {
            priority: 1,
            restrict: 'EA',
            replace: true,
            ...
            template: '<div class="row" id="address">' +
            '<label class="control-label  col-md-2">省</label>'+
            '<div class="col-md-4">' +
            '<select name="province" class="form-control" ng-model="province" ng-options="province.ProID as province.ProName for province in provinces">' +
            '<option value="">请选择省份</option>' +
            '</select>' +
            '</div>' +
            '<label class="control-label  col-md-2">市</label>'+
            '<div class="col-md-4">' +
            '<select name="city" class="form-control" ng-model="city" ng-options="city.CityID as city.CityName for city in filteredCities">' +
